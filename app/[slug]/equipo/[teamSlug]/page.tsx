  ...
  return <main className="min-h-screen bg-slate-50 text-slate-950">
    ...
    <div className="mx-auto max-w-6xl space-y-6 px-4 py-8">
      <div className="flex justify-end">
        <div className="grid w-full gap-2 sm:flex sm:w-auto"><Link href={`/${slug}/fases`} className="flex items-center justify-center gap-2 rounded-xl border border-indigo-200 bg-indigo-50 px-5 py-3 text-[10px] font-black uppercase tracking-widest text-indigo-700 transition-colors hover:bg-indigo-100"><Trophy size={16} /> Ver fases y finales</Link><Link href={`/${slug}/resultados?tournament=${encodeURIComponent(String(category?.tournaments?.id))}`} className="flex items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-5 py-3 text-[10px] font-black uppercase tracking-widest text-blue-700 transition-colors hover:bg-blue-100"><BarChart3 size={16} /> Ver resultados generales</Link></div>
      </div>
